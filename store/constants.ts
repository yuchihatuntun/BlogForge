...
export const TIMELINE: Array<TimelineNodeV2> = [
  ...
  {
    type: NodeTypes.CHECKPOINT,
    title: 'Three Years of Struggle, Aiming for the College Entrance Exam',
    size: ItemSize.SMALL,
    subtitle: 'A Thousand Days of Preparation, Decisive Battle in the College Entrance Exam 🎯',
    image: '/timeline/高考.svg',
    slideImage: '/timeline/HSDFZ.jpeg',
    shouldDrawLine: true,
  ...
  {
    type: NodeTypes.CHECKPOINT,
    title: '2016-2020: Four Years at Harbin No.47 Middle School',
    size: ItemSize.LARGE,
    shouldDrawLine: false,
    alignment: Branch.LEFT,
  },
